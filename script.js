...
const game = {
    ...
    generateOptionShip(shipSize) {
        ...
        if(direction) {
            x= Math.floor(Math.random() * areaSize);
            y= Math.floor(Math.random() * (areaSize - shipSize));
        } else {
            x= Math.floor(Math.random() * (areaSize - shipSize));
            y= Math.floor(Math.random() * areaSize);
        }
        ...
        for (let i = 0; i < location.length; i++) {
            ...
            for (let j = startCoordX; j < startCoordX + 3; j++) {
                ...
                for (let z = startCoordY; z < startCoordY + 3; z++) {
                    ...
                    if (j >=0 && j < areaSize && z >= 0 && z < areaSize){
                        const coord = j + '' + z;
